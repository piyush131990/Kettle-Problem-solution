# Kettle
C# Programming Test – Kettle Controller
...
3.  The projects have been created using Visual Studio 2017 with .Net Core 2.1 and .Net Standard 2.0. Feel free to use a different version of Visual Studio and .NET.
